 ...
 * @returns {*}
 */
CommonUtil.bytesToSize = function(bytes) {
    try {
        bytes = Number(bytes);
 ...
 * @returns {boolean}
 */
CommonUtil.startWith = function (str, fullStr) {
    var reg = new RegExp("^" + str);
    return reg.test(fullStr);
};
 ...
 * @returns {string}
 */
CommonUtil.randomString = function(len) {
    len = len || 5;
 ...
 * @returns {boolean}
 */
CommonUtil.endWith = function (str, fullStr) {
    var reg = new RegExp(str + "$");
    return reg.test(fullStr);
};
